...
<form  method="POST" action="inserirevento.php">
  ...
  <div class="form-group">
    <label>Detalhe</label>
    <input type="text" name="Detalhe" class="form-control"  placeholder="Detalhe">
  </div>
   <div class="form-group">
    <label>Data e Hora</label>
    <input type="datetime"  name="DataeHora" class="form-control" placeholder="YY-MM-DD 00:00:00" >
  </div>
  <div class="form-group">
    <label>Local</label>
    <input type="text"  name="local" class="form-control"  placeholder="Ingrese Local del Evento">
  </div>
