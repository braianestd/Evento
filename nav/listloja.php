...
<section class="pt100 pb100">
    <div class="container">
                ...
                <h1 align="center"> Lista de Lojas</h1>
...
<?php
		foreach($loja as $local):?>
			<tr>
					  ...
					  <td><a href='editarloja.php?id=<?php echo $local->ID;?>'>Editar</a></td>
					  <td><a href='excluirloja.php?id=<?php echo $local->ID;?>'>Eliminar</a></td>
				</tr>
              </tbody>
              <?php endforeach?>
              </table>
