...
$objreg = New Eventos();
$resultado = $objreg->listar();	
$objloja = New Loja();
$resultado2 = $objloja->listar();
?>
...
<form  method="POST" action="regaloinsert.php" enctype="multipart/form-data">
  <div class="form-group">
  <label>Loja</label>
	<select name="id_loja">
	 <option value="">Selecione</option>
		 	 <?php
	 foreach($resultado2 as $loja){
     echo UTF8_encode ("<option value='$loja->ID'>$loja->Nome</option>");
													}
	 ?>
	</div>
  <div class="form-group">
