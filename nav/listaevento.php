...
<section class="pt100 pb100">
    <div class="container">
                ...
                <h1 align="center"> Listar Eventos</h1>
<div class="widget-box">
          <div class="widget-content nopadding">
			...
			<th colspan="4"> Accion</th>
				...
				<tbody>
<?php
		foreach($loja as $local):?>
			<tr>
                      <td><?php echo $local->Nome;?></td>
                      <td><?php echo $local->Detalhe;?></td>
                      <td><?php echo $local->DataeHora;?></td>
                      <td><?php echo $local->local;?></td>
					  <td><a href='editarevento.php?id=<?php echo $local->ID;?>'>Editar</a></td>
					  <td><a href='excluirevento.php?id=<?php echo $local->ID;?>'>Eliminar</a></td>
				</tr>
              </tbody>
              <?php endforeach?>
              </table>
