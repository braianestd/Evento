  ...
  <body>
    ...
    <div class="container"  >
      <form  class="form-signin" method="POST" action="loginusok.php">
        ...
        <input type="password" name="Senha"  class="form-control" placeholder="Ingrese la seña" required>
        <button class="btn btn-lg btn-danger btn-block" type="submit" name="submit" value="Log In">Login</button>
      </form>
