...
class Usuarios{
	...
	//edita o campo pegado pelo get 
		...
		public function inserir(){
			$name = $this->conexao->real_escape_string($_POST['Nome']);
			$email = $this->conexao->real_escape_string($_POST['Email']);
			$password = $this->conexao->real_escape_string($_POST['Senha']);
			$cPassword = $this->conexao->real_escape_string($_POST['cPassword']);
